...
在neck部分插入量化脉冲驱动的自注意力机制​​​​​​​MSAR，提高对小目标、遮挡的关注。
...
在C3K2模块引入​​​​​​​LSKA，利用分离卷积核实现轻量化，同时结合局部和全局信息，提高小目标、遮挡检测
...
在A2C2F模块引入​​​​​​​LSKA，利用分离卷积核实现轻量化，同时结合局部和全局信息，提高小目标、遮挡检测。
...
使用量化脉冲驱动的自注意力机制​​​​​​​MSAR改进A2C2F模块，现轻量化自注意力机制，通过低比特量化权重和二进制脉冲信号显著降低模型参数量与计算能耗，平衡检测效率与精度。
