...
https://github.com/tgf123/YOLOv8_improve/blob/master/YOLOV26.md
...
- ✅ **代码即插即用**：与之前的YOLO26改进模块相辅相成，可以利用其做进一步改进。
...
- 2. 适用于双模态图像，比如一个分支输入rgb图像，另一个输入红外、深度或者其他类型图像，两个分支相结合，提高检测精度。
...
- 🔗 [CSDN博客地址]([https://blog.csdn.net/qq_64693987?type=blog])
- 🧠 论文写作辅导项目（适合配套发表）
